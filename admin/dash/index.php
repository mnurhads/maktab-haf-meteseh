...
$dash = $log->dashboardPanel();

// print_r($dash['sektor']); exit;
?>
<!doctype html>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter"><?= $dash['sektor'] ?></span> Sektor</h2>
                            <p>Total Sektor</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter"><?= $dash['maktab'] ?></span> Maktab</h2>
                            <p>Total Maktab</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter"><?= $dash['putra'] ?></span> Jama'ah</h2>
                            <p>Total Jama'ah Putra</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter"><?= $dash['putri'] ?></span> Jama'ah</h2>
                            <p>Total Jama'ah Putri</p>
                        </div>
